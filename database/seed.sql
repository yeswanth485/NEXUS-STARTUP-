...
-- 0. Auth users (required for profiles FK)
INSERT INTO auth.users (id, email, encrypted_password, email_confirmed_at, raw_app_meta_data, raw_user_meta_data, created_at, updated_at) VALUES
  ('00000000-0000-0000-0000-000000000001', 'alex@demo.nexus',    crypt('Demo123!', gen_salt('bf')), now(), '{"provider":"email","providers":["email"]}', '{"full_name":"Alex Rivera","role":"freelancer"}',    now(), now()),
  ('00000000-0000-0000-0000-000000000002', 'sarah@demo.nexus',   crypt('Demo123!', gen_salt('bf')), now(), '{"provider":"email","providers":["email"]}', '{"full_name":"Sarah Chen","role":"freelancer"}',       now(), now()),
  ('00000000-0000-0000-0000-000000000003', 'marcus@demo.nexus',  crypt('Demo123!', gen_salt('bf')), now(), '{"provider":"email","providers":["email"]}', '{"full_name":"Marcus Johnson","role":"freelancer"}',   now(), now()),
  ('00000000-0000-0000-0000-000000000004', 'priya@demo.nexus',   crypt('Demo123!', gen_salt('bf')), now(), '{"provider":"email","providers":["email"]}', '{"full_name":"Priya Patel","role":"freelancer"}',     now(), now()),
  ('00000000-0000-0000-0000-000000000005', 'james@demo.nexus',   crypt('Demo123!', gen_salt('bf')), now(), '{"provider":"email","providers":["email"]}', '{"full_name":"James Wilson","role":"freelancer"}',     now(), now()),
  ('00000000-0000-0000-0000-000000000006', 'luna@demo.nexus',    crypt('Demo123!', gen_salt('bf')), now(), '{"provider":"email","providers":["email"]}', '{"full_name":"Luna Martinez","role":"freelancer"}',    now(), now()),
  ('00000000-0000-0000-0000-000000000007', 'ethan@demo.nexus',   crypt('Demo123!', gen_salt('bf')), now(), '{"provider":"email","providers":["email"]}', '{"full_name":"Ethan Brooks","role":"freelancer"}',     now(), now()),
  ('00000000-0000-0000-0000-000000000008', 'maya@demo.nexus',    crypt('Demo123!', gen_salt('bf')), now(), '{"provider":"email","providers":["email"]}', '{"full_name":"Maya Singh","role":"freelancer"}',       now(), now()),
  ('00000000-0000-0000-0000-000000000009', 'client@demo.nexus',  crypt('Demo123!', gen_salt('bf')), now(), '{"provider":"email","providers":["email"]}', '{"full_name":"Sarah Mitchell","role":"client"}',       now(), now()),
  ('00000000-0000-0000-0000-000000000010', 'startup@demo.nexus', crypt('Demo123!', gen_salt('bf')), now(), '{"provider":"email","providers":["email"]}', '{"full_name":"David Park","role":"startup"}',          now(), now())
ON CONFLICT (id) DO NOTHING;

-- 1. Clean up all seeded data (safe to re-run)
...
INSERT INTO public.projects (id, client_id, title, description, category, budget_min, budget_max, timeline, experience_level, project_type, skills_required, status, created_at) VALUES
  ('b0000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000009', 'E-Learning Platform Dashboard',   'Build a comprehensive analytics dashboard for our edtech platform.',                    'Web Dev',    15000, 30000, '3 months',    'expert',       'fixed', ARRAY['React','D3.js','Node.js','PostgreSQL','WebSockets'],                        'open', now() - interval '2 days'),
  ('b0000000-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000009', 'Mobile App UI Redesign',          'Complete UI/UX overhaul of our mobile learning app.',                                   'Design',      8000, 15000, '2 months',    'intermediate', 'fixed', ARRAY['Figma','UI Design','Mobile Design','Design Systems'],                       'open', now() - interval '5 days'),
  ('b0000000-0000-0000-0000-000000000010', '00000000-0000-0000-0000-000000000010', 'AI Chatbot Integration',         'Integrate GPT-4 powered chatbot into our analytics platform.',                          'AI/ML',      20000, 40000, '2 months',    'expert',       'fixed', ARRAY['Python','GPT-4','LangChain','FastAPI','React'],                              'open', now() - interval '1 day'),
  ('b0000000-0000-0000-0000-000000000003', '00000000-0000-0000-0000-000000000009', 'Social Media Marketing Campaign', 'Run a 3-month social media campaign targeting Gen Z students.',                         'Marketing',   5000, 10000, '3 months',    'entry',        'hourly', ARRAY['TikTok','Instagram','SEO','Content Creation'],                              'open', now() - interval '3 days'),
  ('b0000000-0000-0000-0000-000000000004', '00000000-0000-0000-0000-000000000009', 'SaaS Payment Integration',       'Implement subscription billing with Stripe.',                                          'SaaS',       12000, 22000, '6 weeks',     'expert',       'fixed', ARRAY['Node.js','Stripe API','React','PostgreSQL','Redis'],                         'open', now() - interval '7 days'),
  ('b0000000-0000-0000-0000-000000000005', '00000000-0000-0000-0000-000000000009', 'E-Commerce Recommendation Engine', 'Build ML-powered product recommendation system.',                                     'AI/ML',      25000, 45000, '4 months',    'expert',       'fixed', ARRAY['Python','TensorFlow','PostgreSQL','Redis','AWS'],                            'open', now() - interval '1 day'),
  ('b0000000-0000-0000-0000-000000000006', '00000000-0000-0000-0000-000000000009', 'Cross-Platform Mobile App',       'Develop a cross-platform mobile app for course access.',                               'Mobile',     20000, 35000, '4 months',    'expert',       'fixed', ARRAY['React Native','Firebase','TypeScript','Stripe','WebSockets'],                'open', now() - interval '4 days'),
  ('b0000000-0000-0000-0000-000000000007', '00000000-0000-0000-0000-000000000010', 'E-Commerce Analytics Dashboard',  'Build real-time analytics dashboard for e-commerce merchants.',                        'Web Dev',    18000, 32000, '3 months',    'expert',       'fixed', ARRAY['React','D3.js','Python','PostgreSQL','WebSockets'],                          'open', now() - interval '2 days'),
  ('b0000000-0000-0000-0000-000000000008', '00000000-0000-0000-0000-000000000010', 'Brand Identity & Website',        'Create complete brand identity and marketing website.',                               'Design',     10000, 18000, '2 months',    'intermediate', 'fixed', ARRAY['Figma','Web Design','Brand Strategy','UI/UX'],                              'open', now() - interval '6 days');

-- 6. Proposals
INSERT INTO public.proposals (id, project_id, freelancer_id, cover_letter, bid_amount, timeline, status, created_at) VALUES
  ('c0000000-0000-0000-0000-000000000001', 'b0000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001', 'I have built 3 similar analytics dashboards for edtech companies.',         22000, '12 weeks',  'pending',  now() - interval '1 day'),
  ('c0000000-0000-0000-0000-000000000002', 'b0000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000002', 'While I am primarily a designer, I have worked on dashboard UI design.',     18000, '10 weeks',  'pending',  now() - interval '12 hours'),
  ('c0000000-0000-0000-0000-000000000003', 'b0000000-0000-0000-0000-000000000004', '00000000-0000-0000-0000-000000000007', 'I have run successful social media campaigns for 4 edtech startups.',        7000,  '3 months',  'viewed',   now() - interval '2 days'),
  ('c0000000-0000-0000-0000-000000000004', 'b0000000-0000-0000-0000-000000000005', '00000000-0000-0000-0000-000000000003', 'Built recommendation systems processing 10M+ queries/day.',                 35000, '12 weeks',  'pending',  now() - interval '6 hours'),
  ('c0000000-0000-0000-0000-000000000005', 'b0000000-0000-0000-0000-000000000006', '00000000-0000-0000-0000-000000000005', 'I have published 8 cross-platform apps with React Native.',                 28000, '14 weeks',  'pending',  now() - interval '1 day'),
  ('c0000000-0000-0000-0000-000000000006', 'b0000000-0000-0000-0000-000000000007', '00000000-0000-0000-0000-000000000001', 'Full-stack developer with e-commerce analytics experience.',               25000, '10 weeks',  'pending',  now() - interval '8 hours');

-- 7. Contracts
INSERT INTO public.contracts (id, project_id, proposal_id, client_id, freelancer_id, title, total_amount, paid_amount, in_escrow, status, progress, created_at) VALUES
  ('00000000-0000-0000-0000-000000000001', 'b0000000-0000-0000-0000-000000000001', 'c0000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000009', '00000000-0000-0000-0000-000000000001', 'E-Learning Platform Dashboard',   22000, 22000, 0,     'completed', 100, now() - interval '60 days'),
  ('00000000-0000-0000-0000-000000000002', 'b0000000-0000-0000-0000-000000000005', 'c0000000-0000-0000-0000-000000000004', '00000000-0000-0000-0000-000000000009', '00000000-0000-0000-0000-000000000003', 'E-Commerce Recommendation Engine', 35000, 15000, 20000, 'active',    40,  now() - interval '30 days'),
  ('00000000-0000-0000-0000-000000000003', 'b0000000-0000-0000-0000-000000000006', 'c0000000-0000-0000-0000-000000000005', '00000000-0000-0000-0000-000000000009', '00000000-0000-0000-0000-000000000005', 'Cross-Platform Mobile App',        28000, 0,     28000, 'active',    10,  now() - interval '14 days');

-- 8. Conversations
INSERT INTO public.conversations (id, participant_ids, project_id, last_message, last_message_at, unread_counts) VALUES
  ('d0000000-0000-0000-0000-000000000001', ARRAY['00000000-0000-0000-0000-000000000009'::uuid, '00000000-0000-0000-0000-000000000001'::uuid], 'b0000000-0000-0000-0000-000000000001', 'Sounds good, lets start next week!',           now() - interval '3 hours',  '{"00000000-0000-0000-0000-000000000001": 0, "00000000-0000-0000-0000-000000000009": 1}'),
  ('d0000000-0000-0000-0000-000000000002', ARRAY['00000000-0000-0000-0000-000000000010'::uuid, '00000000-0000-0000-0000-000000000003'::uuid], 'b0000000-0000-0000-0000-000000000010', 'Can you share some examples of your chatbot work?', now() - interval '1 hour', '{"00000000-0000-0000-0000-000000000003": 1, "00000000-0000-0000-0000-000000000010": 0}'),
  ('d0000000-0000-0000-0000-000000000003', ARRAY['00000000-0000-0000-0000-000000000009'::uuid, '00000000-0000-0000-0000-000000000007'::uuid], 'b0000000-0000-0000-0000-000000000004', 'Great proposal! Lets schedule a call.',         now() - interval '1 day',   '{"00000000-0000-0000-0000-000000000007": 0, "00000000-0000-0000-0000-000000000009": 1}');
...
INSERT INTO public.messages (id, conversation_id, sender_id, content, created_at) VALUES
  ...
  ('e0000000-0000-0000-0000-000000000003', 'd0000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001', 'Thank you! I have attached some similar projects.',                 now() - interval '3 hours'),
...
-- 12. User settings (auto-created by trigger, but seed for completeness)
